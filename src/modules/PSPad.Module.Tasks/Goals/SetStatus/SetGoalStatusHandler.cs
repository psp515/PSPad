...
public sealed class SetGoalStatusHandler(IDocumentStore<Goal> store, IUnitOfWork work, IClock clock)
    : ICommandHandler<SetGoalStatus>
{
    public async Task<CommandResult> HandleAsync(SetGoalStatus command, CancellationToken ct)
    {
