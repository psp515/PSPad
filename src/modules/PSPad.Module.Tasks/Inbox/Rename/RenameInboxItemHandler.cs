...
public sealed class RenameInboxItemHandler(IDocumentStore<Inbox> store, IUnitOfWork work, IClock clock)
    : ICommandHandler<RenameInboxItem>
{
    public async Task<CommandResult> HandleAsync(RenameInboxItem command, CancellationToken ct)
    {
