...
| [0034](0034-account-deletion-bypasses-the-command-pipeline.md) | Account deletion bypasses the command pipeline for a generic cross-collection wipe | Active (amended by [0041](0041-account-deletion-drains-projections-first.md)) | 2026-09-24 | identity, persistence, architecture, security |
...
| [0036](0036-domain-events-dispatched-after-commit.md) | Domain events are dispatched asynchronously after commit and replayed from a marker on startup | Active (amended by [0041](0041-account-deletion-drains-projections-first.md)) | 2026-09-24 | architecture, events, persistence |
