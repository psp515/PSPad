...
| [0031](0031-every-start-hands-back-its-own-pull.md) | Every Start hands back its own pull, because the shell mounts once signed out and once signed in | Active (amends [0030](0030-the-shell-waits-for-the-first-pull-on-a-device-holding-nothing.md)) | 2026-09-23 | sync, identity, ui, offline |
